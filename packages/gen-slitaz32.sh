...
tazpkg -gi linux-video --root=$ROOTFS --local
tazpkg -gi linux-cifs --root=$ROOTFS --local
tazpkg -gi linux-acpi --root=$ROOTFS --local
tazpkg -gi linux-configfs --root=$ROOTFS --local
tazpkg -gi linux-aufs --root=$ROOTFS --local
